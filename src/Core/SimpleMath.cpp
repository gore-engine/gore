...
Rect Viewport::ComputeDisplayArea(DXGI_SCALING scaling, unsigned int backBufferWidth, unsigned int backBufferHeight, int outputWidth, int outputHeight) noexcept
{
    Rect rct = {};
