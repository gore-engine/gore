...
function(vcpkg_init)
    ...
    if(VCPKG_EXECUTABLE EQUAL "" OR NOT DEFINED VCPKG_EXECUTABLE)
        ...
        set(CMAKE_TOOLCHAIN_FILE ${CMAKE_TOOLCHAIN_FILE} CACHE STRING "vcpkg toolchain file" FORCE)
    endif()
endfunction()
...
function(vcpkg_install_manifest)
    ...
    file(COPY "${CMAKE_CURRENT_SOURCE_DIR}/vcpkg.json" DESTINATION "${VCPKG_PARENT_DIR}")
    execute_process(COMMAND ${VCPKG_EXECUTABLE_ABS} --triplet=${VCPKG_TARGET_TRIPLET} --feature-flags=manifests,versions --disable-metrics install WORKING_DIRECTORY "${VCPKG_PARENT_DIR}" RESULT_VARIABLE VCPKG_INSTALL_OK)
    if(NOT VCPKG_INSTALL_OK EQUAL "0")
